/**
 * Signup Page — Guardion
 * Dark cybersecurity themed signup with orange/cyan accents.
 */
...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-brand-black flex items-center justify-center px-4 relative overflow-hidden">
      <div className="absolute top-1/3 right-1/4 w-80 h-80 bg-brand-cyan/5 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/3 left-1/4 w-60 h-60 bg-brand-orange/5 rounded-full blur-[80px] pointer-events-none" />
      ...
      >
        ...
        <div className="bg-brand-card border border-white/5 rounded-xl p-8 shadow-lg">
          <h2 className="text-xl font-semibold text-white mb-1 font-poppins">Create your account</h2>
          <p className="text-sm text-gray-500 mb-6">Start securing your AI workflow</p>
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            ...
            <Link to="/login" className="text-brand-cyan hover:text-brand-cyan-light font-medium">
              Sign in
            </Link>
          </p>
        </div>
